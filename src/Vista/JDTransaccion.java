...
public class JDTransaccion extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbxTtrans = new javax.swing.JComboBox<>();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txtDocumento, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), "Transacciones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(204, 0, 0))); // NOI18N

        jLabel2.setText("Codigo Transaccion");

        lblidt.setText("cod");

        cbxTtrans.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Retiro", "Consignacion" }));

        jLabel9.setText("Tipo Transaccion");

        jLabel10.setText("Fecha");

        btnRegistrar.setText("Realizar");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(19, 19, 19))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cbxTtrans, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 33, Short.MAX_VALUE)
                        .addComponent(txtValor, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblidt, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void codigo() {
        ...
        try {
            ...
            Logger.getLogger(JDTransaccion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ClienteC obj = new ClienteC();
        try {
            CachedRowSet crs = obj.buscarCuenta(Integer.parseInt(txtDocumento.getText()), cbxTipoC.getSelectedItem().toString());
            crs.next();
            cbxTipoC.setSelectedItem(crs.getString(4));
            txtNombre.setText(crs.getString(2));
            txtApellido.setText(crs.getString(3));
            txtNcuenta.setText(String.valueOf(crs.getInt(1)));
            txtSaldo.setText(String.valueOf(crs.getInt(5)));
    ...
    int nCuenta = Integer.parseInt(txtNcuenta.getText());
    String tipo = cbxTtrans.getSelectedItem().toString();
    String fecha = txtFecha.getText();
    int valor = Integer.parseInt(txtValor.getText());
    TransaccionC obj = new TransaccionC(nCuenta, tipo, fecha, valor);
        try {
            JOptionPane.showMessageDialog(this, obj.registrarTrans());
            btnBuscar.doClick();
        } catch (Exception ex) {
            Logger.getLogger(JDTransaccion.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void limpiarCta(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDTransaccion.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> cbxTtrans;
    ...
    private javax.swing.JLabel lblidt;
